# Lista de Descripciones de Tablas y Atributos - SGSPCSI

Este documento contiene únicamente las descripciones de cada tabla y de cada atributo.

## Tabla: rol

- Descripción de la tabla: Catálogo de roles de seguridad del sistema. Almacena los perfiles de acceso disponibles en la aplicación.
...
- > Descripción de la tabla: Usuarios del sistema con datos personales atómicos. Almacena información de identidad separada en campos discretos para normalización.
...
- Descripción de la tabla: Relación N:M entre usuarios y roles. Asigna perfiles de acceso a usuarios con control de vigencia.
...
- > fecha_asignacion: Fecha y hora exacta en que ese rol se asignó al usuario. Permite trazabilidad temporal, auditoría y seguimiento del ciclo de vida del proceso.
...
- Descripción de la tabla: Estructura organizacional jerárquica. Almacena direcciones, coordinaciones y departamentos con relación padre-hijo.
...
- Descripción de la tabla: Relación N:M entre usuarios y áreas. Vincula usuarios a áreas organizacionales con control de titularidad.
...
- Descripción de la tabla: Catálogo de sistemas institucionales. Almacena aplicaciones y sistemas disponibles en la institución.
...
- Descripción de la tabla: Relación N:M entre áreas y sistemas. Define qué sistemas son visibles y accesibles por cada área.
...
- Descripción de la tabla: Relación N:M entre sistemas y usuarios (desarrolladores). Asigna técnicos responsables de cada sistema.
...
- tipo_participación: Rol operativo de la persona en la actividad: RESPONSABLE cuando lidera y PARTICIPANTE cuando colabora.
...
- Descripción de la tabla: Catálogo de tipos de solicitud. Define las categorías principales de solicitudes en el sistema.
...
- Descripción de la tabla: Estados del ciclo de vida de solicitudes. Define los estados por los que puede transitar una solicitud.
...
- Descripción de la tabla: Catálogo de prioridades. Define los niveles de urgencia para solicitudes.
...
- Descripción de la tabla: Entidad principal de negocio. Almacena todas las solicitudes (tickets) del sistema con trazabilidad completa.
...
- Descripción de la tabla: Relación N:M entre solicitudes y desarrolladores. Asigna técnicos responsables de cada solicitud.
...
- Descripción de la tabla: Bitácora de cambios de estado. Registra el historial completo de transiciones de estado de cada solicitud.
...
- Descripción de la tabla: Aprobaciones y evaluaciónes. Registra las decisiones de aprobación, rechazo o solicitud de información.
...
- Descripción de la tabla: Comentarios y anotaciones. Almacena comentarios de usuarios en solicitudes para seguimiento.
...
- Descripción de la tabla: Evidencias y archivos. Almacena archivos adjuntos que soportan solicitudes.
...
- Descripción de la tabla: Notificaciones de usuarios. Almacena avisos y alertas enviadas a usuarios del sistema.

Atributos:

- notificación_id: Clave numérica autogenerada que identifica este registro de forma única, no se captura manualmente y no puede repetirse. Este valor lo genera automáticamente el sistema y funciona como identificador principal del registro.
...
- Descripción de la tabla: Seguridad y auténticación. Almacena credenciales y datos de acceso del usuario.
...
- Descripción de la tabla: Menú de navegación. Define opciones y rutas del sistema con jerarquía.
...
- Descripción de la tabla: Permisos de menú por rol. Define qué opciones puede ver y usar cada rol.
...
- Descripción de la tabla: Tipos de modificación. Clasifica las modificaciones en adaptativas, evolutivas o correctivas.
...
- Descripción de la tabla: Detalles de modificación. Almacena información específica de solicitudes de modificación de sistemas.
...
- Descripción de la tabla: Especificaciones técnicas. Detalla requerimientos técnicos después de aprobación de solicitud.
...
- Descripción de la tabla: Tareas operativas. Descompone solicitudes en tareas concretas de desarrollo.
...
- Descripción de la tabla: Asignaciones de tarea. Vincula usuarios a tareas con roles específicos.

Atributos:

- tarea_desarrollo_asignación_id: Clave numérica autogenerada que identifica este registro de forma única, no se captura manualmente y no puede repetirse. Este valor lo genera automáticamente el sistema y funciona como identificador principal del registro.
...
- rol_técnico: Rol operativo de la persona en la actividad: RESPONSABLE cuando lidera y PARTICIPANTE cuando colabora.
- activa: Bandera de vigencia: 1 significa que el elemento esta habilitado para uso, 0 significa que no debe utilizarse. Valor 1 = activo o vigente; valor 0 = inactivo o no vigente.
- fecha_asignacion: Fecha y hora exacta en que se realizo la asignación en el sistema. Permite trazabilidad temporal, auditoría y seguimiento del ciclo de vida del proceso.
- fecha_fin: Fecha y hora en que finaliza formalmente la asignación o relación; puede quedar vacía si sigue vigente. Permite trazabilidad temporal, auditoría y seguimiento del ciclo de vida del proceso.
...
- Descripción de la tabla: Bitácora de actividades. Registra eventos recientes para paneles de seguimiento.
...
- Descripción de la tabla: Gestión de proyectos. Agrupa solicitudes, equipo y planificación en iniciativas.
...
- Descripción de la tabla: Relación N:M entre proyectos y solicitudes. Vincula solicitudes con iniciativas.
...
- solicitud_id: Llave foránea que enlaza este registro con la solicitud origen del proceso. Se usa para relacionar este registro con otra tabla y mantener la integridad referencial de los datos.
- fecha_vinculación: Fecha y hora en que se establecio formalmente la relación entre proyecto y solicitud. Permite trazabilidad temporal, auditoría y seguimiento del ciclo de vida del proceso.

---

## Tabla: proyecto_miembro

- Descripción de la tabla: Miembros de proyecto. Asigna usuarios a proyectos con roles operativos.
...
- Descripción de la tabla: Documentos de proyecto. Almacena archivos asociados a proyectos y solicitudes.
...
- Descripción de la tabla: Eventos de calendario. Registra reuniones, entregas, revisiones y actividades.
...
- creado_por_usuario_id: Usuario que registro originalmente este elemento en el sistema y que funge como autor inicial. Este valor lo genera automáticamente el sistema y funciona como identificador principal del registro.
- es_todo_día: Tipo de agenda del evento: 1 cubre el día completo, 0 tiene hora de inicio y fin.

---

## Tabla: evento_participante

- Descripción de la tabla: Participantes de evento. Registra asistentes y su estado de confirmación en eventos.
