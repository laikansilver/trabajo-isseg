...
function populateMaps(extensions, types) {
    ...
    Object.keys(db__default['default']).forEach((type) => {
        const mime = db__default['default'][type];
        ...
        for (const extension of exts) {
            if (types[extension]) {
                const from = preference.indexOf(db__default['default'][types[extension]].source);
...
function charset(type) {
    ...
    const mime = match && db__default['default'][match[1].toLowerCase()];
